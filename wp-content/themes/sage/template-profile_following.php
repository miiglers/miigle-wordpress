<?php
/**
 * Template Name: Profile - Following
 */
?>

<div id="template-profile_following">
        ...
        <div class="col-md-10 col-md-offset-1 hero"> 
          <div class="profile-thumb text-center">
        	...
        	<div class="profile-social text-center white-text">
        		<a href="#" target="_blank">@miigle_username</a>&nbsp;|&nbsp;
        		<a href="#" target="_blank">website.com</a>&nbsp;|&nbsp;
        		...
        		<div class="col-md-3">
        			<div class="card-item">
        				<div class="profile-thumb text-center">
        					...
        					@miigle_username</div>
        				<div class="follow-btn text-center">
        					<a href="#" class="btn btn-following">Following</a>
        				</div>
        			</div>
        		</div>
        		<div class="col-md-3">
