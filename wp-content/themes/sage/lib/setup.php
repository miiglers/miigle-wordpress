...
function assets() {
  ...
  wp_enqueue_style('sage/css', get_template_directory_uri() . '/assets/styles/main.css', false, '0.0.1');
  ...
  wp_enqueue_script('sage/js', get_template_directory_uri() . '/assets/styles/main.js', ['jquery'], null, true);
}
