...
function assets() {
  ...
  wp_enqueue_style('sage/css', get_template_directory() . 'assets/styles/main.css', false, null);
  ...
  wp_enqueue_script('sage/js', get_template_directory() . 'assets/styles/main.js', ['jquery'], null, true);
}
