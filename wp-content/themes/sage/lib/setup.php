...
function assets() {
  ...
  wp_enqueue_style('googlefonts', 'https://fonts.googleapis.com/css?family=Montserrat:400,600,700|Open+Sans:300,400,700,400italic|Lato', false, null);
  wp_enqueue_style('sage/css', get_template_directory_uri() . '/assets/styles/main.css', ['bootstrap/css', 'fontawesome', 'googlefonts'], '0.0.35');
  ...
  wp_enqueue_script('sage/js', get_template_directory_uri() . '/assets/scripts/main.js', ['jquery', 'validate', 'bootstrap/js', 'wp-api'], '0.0.13', true);
}
