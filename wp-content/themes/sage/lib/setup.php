...
function assets() {
  ...
  wp_enqueue_style('sage/css', get_template_directory_uri() . '/assets/styles/main.css', ['bootstrap/css', 'fontawesome', 'googlefonts'], '0.0.40');
  ...
  wp_enqueue_script('sage/js', get_template_directory_uri() . '/assets/scripts/main.js', ['jquery', 'validate', 'bootstrap/js', 'wp-api'], '0.0.16', true);
}
